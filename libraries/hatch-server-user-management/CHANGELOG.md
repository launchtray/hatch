...
This log was last generated on Fri, 17 Mar 2023 03:53:52 GMT and should not be manually modified.
...
- update to use hatch middleware for csrf check
...
- Fix type annotation to resolve compilation issue
...
- Added health check endpoints to default auth whitelist
...
- Add tenant ID to get user info method
...
- Updates to controller OpenAPI definitions
