...
- Exposed app info via new health endpoint
...
- Add default response of object type for OpenAPI spec
...
- OpenAPI interface and builder improvements
...
- Added printing of base URL in development mode
