...
### Components
Controllers can be generated by running `hatch component <ModuleName>`, and should live in the 
...
[containers](src/containers) directory.
...
### Actions
Actions should live in the [actions](src/actions) directory.
